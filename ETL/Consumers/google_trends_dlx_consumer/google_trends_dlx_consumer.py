...
QUEUE_NAME = 'google_trends_queue_error'
...
failed_collection = db['failed_google_trends']  # Collection pour les messages échoués
...
print("Start consuming DLX google trends messages")
