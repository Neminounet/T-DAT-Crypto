...
channel.exchange_declare(exchange='dlx_live_price', exchange_type='fanout', durable=True)

# Déclarer la queue d'erreur et la lier à l'exchange DLX
channel.queue_declare(queue='live_price_queue_error', durable=True)

#Lier les deux O.o
channel.queue_bind(exchange='dlx_live_price', queue='live_price_queue_error')

# Déclarer la queue principale avec les arguments pour DLX
args = {
    'x-dead-letter-exchange': 'dlx_live_price',
    'x-message-ttl': 60000
}
...
print("Start consuming live prices")
