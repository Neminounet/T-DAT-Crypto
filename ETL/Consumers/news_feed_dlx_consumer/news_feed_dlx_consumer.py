...
QUEUE_NAME = 'news_feed_queue_error'
...
failed_collection = db['failed_news_feed']  # Collection pour les messages échoués
...
print("Start consuming DLX news feed messages")
