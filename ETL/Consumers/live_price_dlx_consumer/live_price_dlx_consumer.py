...
QUEUE_NAME = 'live_price_queue_error'
...
failed_collection = db['failed_live_prices']  # Pour stocker les messages qui ont définitivement échoué
...
print("Start consuming DLX live price messages")
