...
import json
import time
from data_functions import save_news_message
...
channel.exchange_declare(exchange='dlx_news_feed', exchange_type='fanout', durable=True)

# Déclarer la queue d'erreur et la lier à l'exchange DLX
channel.queue_declare(queue='news_feed_queue_error', durable=True)
channel.queue_bind(exchange='dlx_news_feed', queue='news_feed_queue_error')
...
print("Start consuming news feeds")
